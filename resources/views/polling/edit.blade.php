                ...
                <form action="{{route('polling-update', ['polling' => $pol->id])}}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="my-2 form-control" type="text" name="nama" id="nama" placeholder="Periode" autofocus maxlength="100" value="{{$pol->nama}}">
                        </div>
                        <div class="form-group">
                            <label for="started_date">Tanggal Mulai</label>
                            <input class="my-2 form-control" type="date" name="started_date" id="started_date" placeholder="Tanggal Mulai" autofocus maxlength="100" value="{{ $pol->started_date ? date('Y-m-d', strtotime($pol->started_date)) : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="ended_date">Tanggal Akhir</label>
                            <input class="my-2 form-control" type="date" name="ended_date" id="ended_date" placeholder="Tanggal Mulai" autofocus maxlength="100" value="{{ $pol->ended_date ? date('Y-m-d', strtotime($pol->ended_date)) : '' }}">
                        </div>
                        {{-- Status Polling --}}
                        <div class="form-group">
